...
>>>>>>> d01921e03d8f442df2a15f95ec9e4853fc9f328d
                ...
                if (response.status >= 200 && response.status < 300) {
                  ...
                  setReference('')
                  setTimeout(() => {
                    navigate(currentLocation.state?.from || '/dashboard_2');
                }, 1500);
                } else {
    ...
    <div className='grid grid-cols-1 md:grid-cols-4 gap-4' style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
        ...
        <div className='mb-4' style={{ width: '22%', height:'4%' }}>
            ...
            <PhoneInput
                ...
                inputProps={{ required: true, className: 'w-11/12 border border-gray-400 outline-0 rounded overflow-hidden shadow-md ml-7 pl-3 p-2', style: { fontFamily: "'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif" } }}
            />
        </div>
        ...
        <div className='mb-4' style={{ width: '22%', height:'4%' }}>
            ...
            {Status !== "Won" && Status !== "Lost" && (
                <DatePicker
                    ...
                    dateFormat="MM-dd-yyyy"
                    className="border w-full ml-0.5 mr-14 pr-16 border-gray-400 rounded-md p-2 overflow-hidden shadow-md outline-none"
                    minDate={todaysDate}
                    placeholderText="mm-dd-yyyy"
