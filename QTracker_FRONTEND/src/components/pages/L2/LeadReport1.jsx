...
<<<<<<< HEAD
          ...
          <div className="flex justify-between items-center">
            {/* <div className="mt-4">
              ...
              <select
                className="border-2 border-gray-400 rounded-md mb-2 p-1 overflow-hidden shadow-md outline-none"
                id="entriesPerPage"
                value={itemsPerPage}
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {currentData.map((LeadReport, index) => (
                <tr className="border text-sm" key={LeadReport.id}>
                  ...
                  <td
                    onClick={() =>
                      navigate(`/editlead1/${LeadReport.id}`, {
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {currentData.map(LeadReport => (
                                <tr className='border text-sm' key={LeadReport.id}>
                                    ...
                                    <td onClick={() =>navigate(`/editlead1/${LeadReport.id}`, {state: { from: location.pathname },})} className="px-4 hover:bg-black cursor-pointer hover:text-white text-center py-2"><MdEditSquare size={20} /></td>
