...
>>>>>>> d01921e03d8f442df2a15f95ec9e4853fc9f328d
        // Check if groupFilter is empty or undefined and handle it accordingly
        if (!groupFilter || groupFilter === "--All--") {
            // If no group is assigned, reset the filtered data to the original LeadReports
...
>>>>>>> d01921e03d8f442df2a15f95ec9e4853fc9f328d
            // Only set filtered data if there is at least one report with the assigned group
            if (filtered.length > 0) {
                setFilteredLeadReports(filtered);
            } else {
                // Optionally, you can handle the case when no reports match the group filter
                // For example, you might want to show a message indicating no reports are found
                console.log('No reports found for the selected group');
                setFilteredLeadReports([]);  // Set an empty list or show a default message
            }
<<<<<<< HEAD
...
>>>>>>> d01921e03d8f442df2a15f95ec9e4853fc9f328d
    ...
    const filterLeadReports = useCallback(
        ...
        [LeadReports] // Dependencies for memoization
    );
...
<<<<<<< HEAD
                ...
                if (response.status >= 200 && response.status < 300) {
                    ...
                    //(lead) => lead.AssignedGroup === empGroups
                    // );
...
>>>>>>> d01921e03d8f442df2a15f95ec9e4853fc9f328d
        ...
        fetchStatus();
    }, [enqueueSnackbar, empGroups, fileUpload]);
...
>>>>>>> d01921e03d8f442df2a15f95ec9e4853fc9f328d
                if (response.status === 200) {
                    // Assuming response.data is an array of group objects and empGroups is an array of strings
...
>>>>>>> d01921e03d8f442df2a15f95ec9e4853fc9f328d
                    setGroupNames(filteredGroups);  // Store the filtered groups
                } else {
...
<<<<<<< HEAD
        ...
        fetchGroupName();
    }, [enqueueSnackbar, empGroups]);  // Adding empGroups to the dependency array to update whenever it changes
    ...
    return (
        <>
            <div className="grid grid-rows-[auto_1fr] grid-cols-[15%_1fr] h-screen">
                ...
                <div id="menu-bar" className="fixed z-20 shadow-2xl overflow-hidden flex flex-col min-h-screen bg-black text-white transition-transform duration-300 ease-in-out" style={{ width: "15%" }}>
...
>>>>>>> d01921e03d8f442df2a15f95ec9e4853fc9f328d
                    ...
                    <div className=' pl-10 p-4 bg-white  border border-gray-200 relative overflow-hidden shadow-lg w-full justify-center top-16'>
                        <div className='flex'>
...
>>>>>>> d01921e03d8f442df2a15f95ec9e4853fc9f328d
                                            ...
                                            <td onClick={() => navigate(`/editlead2/${LeadReport.id}`)} className="px-4 hover:bg-black cursor-pointer hover:text-white text-center py-2"><MdEditSquare size={20} /></td>
