...
>>>>>>> d01921e03d8f442df2a15f95ec9e4853fc9f328d
                ...
                if (response.status >= 200 && response.status < 300) {
                  ...
                  setReference('')
                  setTimeout(() => {
                    navigate(currentLocation.state?.from || '/dashboard_3');
                }, 1500);
                } else {
...
<div className='fixed flex justify-end z-10 py-3 w-full  overflow-hidden text-white '>
            ...
            <div id="menu-bar" className="fixed z-20 shadow-2xl overflow-hidden flex flex-col min-h-screen bg-black text-white w-full sm:w-1/3 md:w-1/4 lg:w-1/6 transform -translate-x-full sm:translate-x-0 transition-transform duration-300 ease-in-out" style={{width:"15%"}}>
...
<div className='ml-80 p-4 bg-white mb-16 border border-gray-200 relative overflow-hidden shadow-lg w-3/4 justify-center top-16' style={{ marginLeft: "20%", paddingLeft: "4%" }}>
    ...
    <div className='grid grid-cols-1 md:grid-cols-4 gap-4' style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
        ...
        <div className='mb-4' style={{ width: '22%', height:'4%' }}>
            ...
            <PhoneInput
                ...
                inputProps={{ required: true, className: 'w-11/12 border border-gray-400 outline-0 rounded overflow-hidden shadow-md ml-7 pl-1 p-2', style: { fontFamily: "'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif" } }}
            />
        </div>
    ...
    <div className='grid grid-cols-1 md:grid-cols-4 gap-4' style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
        ...
        <div className='mb-4' style={{ width: '22%', height:'4%' }}>
            ...
            {Status !== "Won" && Status !== "Lost" && (
                <DatePicker
                    ...
                    dateFormat="MM-dd-yyyy"
                    className="border w-full ml-0.5 mr-12 pr-16 border-gray-400 rounded-md p-2 overflow-hidden shadow-md outline-none"
                    minDate={todaysDate}
                    placeholderText="mm-dd-yyyy"
        ...
        <div className='mb-4' style={{ width: '22%', height:'4%' }}></div>
    </div> 
         <br></br>
        {/* Comments */}
        <div className=''>
